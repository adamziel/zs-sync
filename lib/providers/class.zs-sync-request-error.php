...
class ZS_Sync_Request_Error {
	/**
	 * HTTP status codes for various sync-related error types.
	 */
	 ...
	 * @return ZS_Sync_Request_Error The error object.
	 */
	public static function create( $code, $message = '' ): ZS_Sync_Request_Error {
